...
const Home = () => {
  ...
  useEffect(()=>{fetchDashboardData(); return ()=>{}},[])
  ...
  return (
    <DashboardLayout activeMenu="Dashboard">
      <div className='my-5 mx-auto'>
        ...
        <FinanceOverview totalBalance={dashboardData?.totalBalance || 0} totalExpense={dashboardData?.totalExpense || 0} totalIncome={dashboardData?.totalIncome || 0}  />
        <ExpenseTransactions transactions = {dashboardData?.last30DaysExpenses?.transactions || []} onSeeMore={()=>navigate('/expense')}/>
          ...
          <RecentIncomeWithCharts data={dashboardData?.last60DaysIncome?.transactions?.slice(0,4) || []} totalIncome={dashboardData?.totalIncome || 0}/>
